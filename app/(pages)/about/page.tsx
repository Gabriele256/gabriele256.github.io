...
export default function Page() {
    return (
        <div
            className="w-full min-h-screen p-4 flex flex-col items-center gap-12"
...
/*
<section className="text-left w-full flex flex-row gap-6">
                <div className="p-8 flex flex-col items-start justify-start w-full h-full rounded-4xl backdrop-blur-2xl bg-white/5">
                    <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-linear-to-br from-white to-white/40">
                        Tech Stack
                    </h1>
                    <div className="grid grid-cols-4 gap-4 w-full">
